 ...
 <div class="app-container">
      <div class="filter-container">
         ...
         <router-link :to="{name:'CreateContent'}">
          <el-button type="primary"  style="margin-left: 10px;"  plain>添加内容</el-button>
          </router-link>
...
<script>
   import { contentList , delContent } from '@/api/content'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        contentList(this.listQuery).then(response => { console.log(response)
      ...
      handleDelete(index, row) {
        ...
        this.$confirm('此操作将永久删除, 是否继续?', '提示', {
          ...
          delContent(index.id).then(response => {
          this.$notify({
            message: '删除成功',
            type: 'success',
            duration: 2000
